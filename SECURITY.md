...
1. Open a private [GitHub Security Advisory](https://github.com/GrayCodeAI/sight/security/advisories/new), **or**
...
- LLM provider services that sight integrates with (report to the
  provider).
- Local filesystem misuse where an attacker already has shell access (out of
  threat model).

For sight-specific threat-model notes, see the README and any docs in
this repo.
